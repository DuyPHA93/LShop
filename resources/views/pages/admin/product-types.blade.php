...
<div class="container-right">
    <div class="">
        ...
        <div class="title-section">
            ...
            <div class="menu-link">
                <span class="item"> <a href="{{ route('productTypeDetail') }}"><i class="fa-solid fa-plus icon"></i>Thêm loại sản phẩm</a>
                </span>
            </div>
        </div>
                ...
                <form action="" method="GET" id="frm">
                    <div id="table_wraper">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="table-length">
                                    ...
                                    </select> trong {{ $productTypes->total() }} kết quả
                                </div>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ url('admin/productType') }}/{{$item->id}}"><img alt="" src="{{ url('') }}/{{ $item->imgSrc }}"></a></td>
                                        <td>{{$item->code}}</td>
                                        ...
                                        <td class="action">
                                            <div class="btn-group action-group">
                                                <a class="btn btn-default btn-sm" href="{{ route('productTypeDetail') }}/{{$item->id}}">Xem</a>
                                                <button class="btn btn-default btn-sm dropdown-toggle" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false"></button>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item delete" href="{{ route('deleteProductType') }}"
                                                            data-id="{{$item->id}}"><i class="fa-solid fa-xmark icon"></i>Xóa</a>
                                                    </li>
                                                    <li><a class="dropdown-item disable" href="{{ route('disableProductType') }}"
                        ...
                        <div class="row">
                                ...
                                <div class="table-bulk-action">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item delete" href="{{ route('deleteProductType') }}"><i
                                                        class="fa-solid fa-xmark icon"></i>Xóa</a></li>
                                            <li><a class="dropdown-item disable" href="{{ route('disableProductType') }}"><i
                            ...
                            <div class="col-sm-6 text-end">
                                {{ $productTypes->links('vendor.pagination.custom') }}
                            </div>
                        </div>
                    </div>
                </form>
